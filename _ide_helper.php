...
namespace Illuminate\Support\Facades { 
    ...
    class Request {
        ...
        {
            return \Illuminate\Http\Request::area();
        }
        ...
        {
            return \Illuminate\Http\Request::isFront();
        }
        ...
        {
            return \Illuminate\Http\Request::isAdmin();
        }
    ...
    class Route {
         ...
         * @static 
         */ 
        public static function module($module, $menu = null)
        {
            return \Illuminate\Routing\Router::module($module, $menu);
        }
