...
{{ __t('mail.requested_pw') }} [{{ Request::getHost() }}]({{ action('Front\Auth\ResetPasswordController@showResetForm', [$token]) }}?email={{ urlencode($user->email) }}).
...
{{ __t('kcms.mail.change_pw_mistake') }}
@endcomponent
